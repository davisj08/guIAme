...
export default function PerfilPage() {
  ...
  const { data: pontuacao, error: errorPontuacao } =
    useSWR('minhaPontuacao', gamificacaoService.getMinhaPontuacao)

  const { data: badges, error: errorBadges } =
    useSWR('minhasBadges', gamificacaoService.getMinhasBadges)
