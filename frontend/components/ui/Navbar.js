        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <Link key={link.href} href={link.href}>
                <a className="text-gray-700 hover:text-primary font-medium transition-colors duration-200 relative group">
                  {link.label}
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                <Link href="/login">
                  <a className="text-gray-700 hover:text-primary font-medium transition-colors duration-200">
                    Entrar
                  </a>
                </Link>
                <Link href="/cadastro">
                  <a className="bg-primary text-white font-semibold py-2 px-6 rounded-full hover:bg-blue-700 transition-all duration-300 hover:scale-105 shadow-md">
                    Cadastre-se
                  </a>
                </Link>
              </>
